...
obs1 = "TTG"
(dm, dm_err) = find_offset(t, obs1, "HMB", (58940,58960))
...
t = remove_obs_band(t,"MAK","V")
t = remove_obs_band(t,"SDM","V")
t = remove_obs_band(t,"NLX","V")
